...
- [Bulk purchase POC delivery](bulk-poc-delivery.md) — Deriv API routes initial subscription response only through Promise, not onMessage(); processPOCMessage() + duplicate guard fixes it.
